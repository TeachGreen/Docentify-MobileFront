...
export default function videoActivity(){
    ...
    const videoUrl = 'https://www.youtube.com/embed/ZDc17pyLeu0?si=HTniBf_B04Fc6PRG';
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#111111' }}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style = {{backgroundColor: '#f6f6f6', paddingLeft: 24, paddingRight: 24}}>
                ...
                <Text style={styles.descricao}>
                    Cinema e fotografia com celular
                </Text>
          ...
          color={isChecked ? '#4630EB' : undefined} />
                ...
                <TouchableOpacity disabled={!isChecked} onPress={() => router.push('/mockup/Course02/insideCourse')}>
                    <LinearGradient

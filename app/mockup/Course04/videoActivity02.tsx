...
export default function videoActivity(){
    ...
    const videoUrl = 'https://www.youtube.com/embed/o-1ciQ_I8-4?si=DgeXoQIadQle_IDv';
    ...
    return(
        <SafeAreaView style={{ flex: 1, backgroundColor: '#111111' }}>
          ...
          color={isChecked ? '#4630EB' : undefined} />
                ...
                <TouchableOpacity disabled={!isChecked} onPress={() => router.push('/mockup/Course04/insideCourse')}>
                    <LinearGradient

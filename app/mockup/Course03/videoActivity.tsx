...
export default function videoActivity(){
    ...
    const videoUrl = 'https://www.youtube.com/embed/cvnzkIZjwno?si=AZv1QRpEO5iy3v55';
    ...
    return(
        <SafeAreaView style={{ flex: 1, backgroundColor: '#111111' }}>
          ...
          color={isChecked ? '#4630EB' : undefined} />
                ...
                <TouchableOpacity disabled={!isChecked} onPress={() => router.push('/mockup/Course03/insideCourse')}>
                    <LinearGradient
